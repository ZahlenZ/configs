...
vim.keymap.set(
  ...
  "<leader>i",
  "O<esc>o<esc>O",
  { noremap = true, silent = true, desc = "Insert New Section" }
)
...
vim.keymap.set(
  ...
  "<leader>|",
  "<C-w>v",
  { remap = true, silent = true, desc = "[|]Vertical Split" }
)
vim.keymap.set(
  "n",
  "<leader>-",
  "<C-w>s",
  { remap = true, silent = true, desc = "[-]Horizontal Split" }
)
vim.keymap.set(
  "n",
  "<leader>wd",
  "<C-w>c",
  { remap = true, silent = true, desc = "[W]indow [D]elete" }
)
